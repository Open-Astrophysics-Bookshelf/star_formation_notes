...
To obtain the solution as a function of time, we can integrate again. The equation we have just written down is a first-order ODE for the radius as a function of time:
\begin{equation}
