...
At high densities inside a core immediately before a central star forms and begins to radiate, the dominant source of energy is adiabatic compression of the gas. We therefore have a situation much like that considered in Section \ref{ssec:chemevol} for the first stars. We let  $e$ be the thermal energy per unit mass of a particular gas parcel and $\Gamma$ and $\Lambda$ be the rates of change in $e$ due to heating and cooling processes, so
\begin{equation}
\frac{de}{dt} = \Gamma - \Lambda.
\end{equation}
For gas collapsing on a free-fall timescale, we showed in Section \ref{ssec:chemevol} that the heating rate is roughly $c_s^2/t_{\rm ff}$. To be definite we write this out as
\begin{equation}
