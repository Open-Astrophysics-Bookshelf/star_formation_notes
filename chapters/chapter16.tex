...
\begin{eqnarray}
\rho_{\rm thin} & = & \frac{4}{\pi} \frac{\kappa_{\rm P}^2 \sigma_{\rm SB}^2 \mu^2 m_{\rm H}^2 T^4}{C_1^2 G k_B^2} \\
...
\begin{equation}
\Lambda_{\rm thick} = \frac{a_R T^4/\rho}{t_{\rm diff}} = \frac{\sigma T^4}{\kappa_{\rm P} \rho^2 R^2},
\end{equation}
...
\begin{eqnarray}
\rho_{\rm thick} & = & \left(\frac{C_1^2 G \sigma^2 \mu^4 m_{\rm H}^4 T^4}{4\pi^3 C_2^4 k_B^4 \kappa_{\rm P}^2}\right)^{1/3} \\
